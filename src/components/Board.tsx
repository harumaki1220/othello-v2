...
export const Board = ({ board, onCellClick }: Props) => {
  return (
        ...
        <div key={y} className="flex">
          {row.map((cell, x) => (
            <button
              ...
              className="flex h-12 w-12 items-center justify-center border border-green-800 transition-colors hover:bg-green-600 focus:outline-none"
            >
              {cell !== "EMPTY" && (
                <div
